...
MAX_CHARS = 10000  # Сервер сам контролирует лимит символов
...
def browse():
    ...
    try:
        ...
        # Облако само проверяет лимит символов и делает обрезку
        if len(clean_text) > MAX_CHARS:
            clean_text = clean_text[:MAX_CHARS] + "\n\n[Внимание: Текст сайта слишком длинный и был частично обрезан в облаке]"
